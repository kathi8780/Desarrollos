...
<form name="formulario_personas" method="post" action="<?php echo base_url(); ?>index.php/clientes/clientes/procesarFormularioGestionPND<?php if(isset($ID_CLIENTE) && $ID_CLIENTE != NULL){ echo "/".$ID_CLIENTE ;} ?>" enctype="multipart/form-data">
    ...
    <div id="rootwizard">
        ...
        <div class="tab-content">
                        ...
                        <div class="form-group form-group-sm">                
                            ...
                            <select disabled="true" class="form-control">
                                ...
                                <?php foreach ($ocupaciones as $ocupacion) { ?>
                                    <option value="<?php echo $ocupacion['OCUPACION']; ?>" <?php if ($ocupacion['OCUPACION'] == "DOCENTE") { ?> selected="selected" <?php } ?>>
            ...
            <div class="tab-pane" id="tab2">
             <h5 class="form-section">Información Profesional</h5>
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="form-group form-group-sm <?php if(form_error('formulario_personas[DOC_TITULO_PROF]') != '' ){ echo "has-error";}?>">                
                            <label class="control-label required" for="formulario_personas_tituloProf">Título profesional<span class="required"> * </span></label>                            
                            <input type="text" id="formulario_personas_tituloProf" name="formulario_personas[DOC_TITULO_PROF]" 
                                    <?php if(form_error('formulario_personas[DOC_TITULO_PROF]') != '' ){?>
                                    aria-describedby="formulario_personas_tituloProf-error"
                                   <?php } ?>
                                   required="required" maxlength="50" class="form-control" 
                                   <?php if(isset($DOC_TITULO_PROF) && $DOC_TITULO_PROF != NULL) { ?> value="<?= $DOC_TITULO_PROF ?>" <?php } ?>
                                   />
                                    <?php if(form_error('formulario_personas[DOC_TITULO_PROF]') != '' ){?>
                                        <span id="formulario_personas_tituloProf-error" class="help-block">
                                            <?= form_error('formulario_personas[DOC_TITULO_PROF]') ?>
                                        </span>
                                    <?php } ?>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="form-group form-group-sm <?php if(form_error('formulario_personas[DOC_INSTITUCION]') != '' ){ echo "has-error";}?>">                
                            <label class="control-label required" for="formulario_personas_institucion">Institución<span class="required"> * </span></label>                            
                            <input type="text" id="formulario_personas_institucion" name="formulario_personas[DOC_INSTITUCION]" 
                                    <?php if(form_error('formulario_personas[DOC_INSTITUCION]') != '' ){?>
                                    aria-describedby="formulario_personas_institucion-error"
                                   <?php } ?>
                                   required="required" maxlength="50" class="form-control" 
                                   <?php if(isset($DOC_INSTITUCION) && $DOC_INSTITUCION != NULL) { ?> value="<?= $DOC_INSTITUCION ?>" <?php } ?>
                                   />
                                    <?php if(form_error('formulario_personas[DOC_INSTITUCION]') != '' ){?>
                                        <span id="formulario_personas_institucion-error" class="help-block">
                                            <?= form_error('formulario_personas[DOC_INSTITUCION]') ?>
                                        </span>
                                    <?php } ?>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="form-group form-group-sm <?php if(form_error('formulario_personas[DOC_REGISTRO_SENESCYT]') != '' ){ echo "has-error";}?>">                
                            <label class="control-label required" for="formulario_personas_senescyt">Registro SENESCYT<span class="required"> * </span></label>                            
                            <input  type="text" id="formulario_personas_senescyt" name="formulario_personas[DOC_REGISTRO_SENESCYT]" 
                                    <?php if(form_error('formulario_personas[DOC_REGISTRO_SENESCYT]') != '' ){?>
                                    aria-describedby="formulario_personas_senescyt-error"
                                   <?php } ?>
                                   required="required" maxlength="50" class="form-control" 
                                   <?php if(isset($DOC_REGISTRO_SENESCYT) && $DOC_REGISTRO_SENESCYT != NULL) { ?> value="<?= $DOC_REGISTRO_SENESCYT ?>" <?php } ?>
                                   />
                                    <?php if(form_error('formulario_personas[DOC_REGISTRO_SENESCYT]') != '' ){?>
                                        <span id="formulario_personas_senescyt-error" class="help-block">
                                            <?= form_error('formulario_personas[DOC_REGISTRO_SENESCYT]') ?>
                                        </span>
                                    <?php } ?>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="form-group form-group-sm <?php if(form_error('formulario_personas[DOC_NIVEL_ALCANZADO]') != '' ){ echo "has-error";}?>">                
                            <label class="control-label required" for="formulario_personas_nivelalcanzado">Nivel logrado<span class="required"> * </span></label>                            
                            <input  type="text" id="formulario_personas_nivelalcanzado" name="formulario_personas[DOC_NIVEL_ALCANZADO]" 
                                    <?php if(form_error('formulario_personas[DOC_NIVEL_ALCANZADO]') != '' ){?>
                                    aria-describedby="formulario_personas_nivelalcanzado-error"
                                   <?php } ?>
                                   required="required" maxlength="50" class="form-control" 
                                   <?php if(isset($DOC_NIVEL_ALCANZADO) && $DOC_NIVEL_ALCANZADO != NULL) { ?> value="<?= $DOC_NIVEL_ALCANZADO ?>" <?php } ?>
                                   />
                                    <?php if(form_error('formulario_personas[DOC_NIVEL_ALCANZADO]') != '' ){?>
                                        <span id="formulario_personas_nivelalcanzado-error" class="help-block">
                                            <?= form_error('formulario_personas[DOC_NIVEL_ALCANZADO]') ?>
                                        </span>
                                    <?php } ?>
                        </div>
                    </div>
