...
<form name="formulario_personas" method="post" action="<?php echo base_url(); ?>index.php/clientes/clientes/procesarFormularioGestionPJ<?php if(isset($ID_CLIENTE) && $ID_CLIENTE != NULL){ echo "/".$ID_CLIENTE ;} ?>">
    ...
    <div id="rootwizard">
        ...
        <!-- footer arriba: salir, siguiente, guardar, anterior -->
        ...
        <div class="tab-content">
            <div class="tab-pane" id="tab1"> <!-- pestaña 1 -->
                 <div class="row">
            ...
            <div class="tab-pane" id="tab2">  
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group form-group-sm">
                            <input type="hidden" id="formulario_personas_idRepresentante" name="formulario_personas[ID_REPRESENTANTE]"  style="display:none" class="form-control" 
                ...
                <div class="row representante">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group form-group-sm">                
                            ...
                            <input type="text" id="formulario_personas_primerNombre" name="formulario_personas[REPRESENTANTE][PRIMER_NOMBRE]" 
                                    mayusculas="^[A-Za-zÁÉÍÓÚáéíóúÑñ]+$" maxlength="50" representante="true" class="form-control" 
                ...
                <div class="row representante">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group form-group-sm">                
                            ...
                            <input type="text" id="formulario_personas_apellidoPaterno"  name="formulario_personas[REPRESENTANTE][APELLIDO_PATERNO]" 
                                   mayusculasespacios="^[A-Za-zÁÉÍÓÚáéíóúñÑ\s]+$" representante="true" maxlength="50" class="form-control" 
                        ...
                        <div class="form-group form-group-sm">                
                            ...
                            <select id="formulario_personas_idOperadorTelefonico" name="formulario_personas['CONTACTO_DOMICILIO'][ID_OPERADOR_TELEFONICO]" class="form-control">
                               ...
                               <?php foreach ($operadoras as $operadora) { ?>
                                    <option value="<?php echo $operadora['ID_OPERADOR_TELEFONICO']; ?>" <?php if ($operadora['ID_OPERADOR_TELEFONICO'] == $ID_OPERADOR_TELEFONICO) { ?> selected="selected" <?php } ?>>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">                
                            ...
                            <textarea id="formulario_personas_direccionReferencia" name="formulario_personas[CONTACTO_DOMICILIO][DIRECCION_REFERENCIA]" maxlength="300" class="form-control"><?php  if(isset($DIRECCION_REFERENCIA) && $DIRECCION_REFERENCIA != NULL) { echo $DIRECCION_REFERENCIA;} ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">                
                            <label class="control-label" for="formulario_personas_direccionDescripcion">Descripción</label>
                            <textarea id="formulario_personas_direccionDescripcion" name="formulario_personas[CONTACTO_DOMICILIO][DESCRIPCION]" maxlength="300" class="form-control"><?php  if(isset($DESCRIPCION) && $DESCRIPCION != NULL) { echo $DESCRIPCION;} ?></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="tab-pane" id="tab4">
             <?php for($i =0; $i<4; $i++){ ?>
                ...
                <div class="row persona-a-contactar-<?= $i ?>">
                    <input style="display: none" type="hidden" name="formulario_personas[PERSONA_CONTACTAR][<?= $i ?>][ID_PERSONA_CONTACTAR]" 
                                     <?php if(isset($PERSONA_CONTACTAR) && isset($PERSONA_CONTACTAR[$i]) && $PERSONA_CONTACTAR[$i]['ID_PERSONA_CONTACTAR'] != NULL) { ?> 
                                     value="<?= $PERSONA_CONTACTAR[$i]['ID_PERSONA_CONTACTAR'] ?>"
                                         <?php } ?>
                                   />
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group form-group-sm <?php if(form_error('formulario_personas[PERSONA_CONTACTAR]['.$i.'][NOMBRE_COMPLETO]') != '' ){ echo "has-error";}?>">                
                            <label class="control-label" for="formulario_personas_persona_contactar_nombre_completo_<?= $i ?>">Nombres y apellidos</label>
                            <input type="text" id="formulario_personas_persona_contactar_nombre_completo_<?= $i ?>" name="formulario_personas[PERSONA_CONTACTAR][<?= $i ?>][NOMBRE_COMPLETO]" 
                                   mayusculasespacios="^[A-Za-zÁÉÍÓÚáéíóúÑñ\s]+$" 
                                   maxlength="50" 
                                   posicion="<?= $i ?>" 
                                   class="form-control" 
                                   
                                    <?php if(form_error('formulario_personas[PERSONA_CONTACTAR]['.$i.'][NOMBRE_COMPLETO]') != '' ){?>
                                    aria-describedby="formulario_personas_persona_contactar_nombre_completo_<?= $i ?>-error"
                                   <?php } ?>
                                   ...
                                   <?php if(form_error('formulario_personas[PERSONA_CONTACTAR]['.$i.'][NOMBRE_COMPLETO]') != '' ){?>
                                    <span id="formulario_personas_persona_contactar_nombre_completo_<?= $i ?>-error" class="help-block">
                                            <?= form_error('formulario_personas[PERSONA_CONTACTAR]['.$i.'][NOMBRE_COMPLETO]') ?>
                                    </span>
                                    <?php } ?>
                        </div>
                    </div>
                   ...
                   <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group form-group-sm <?php if(form_error('formulario_personas[PERSONA_CONTACTAR]['.$i.'][AREA_CARGO]') != '' ){ echo "has-error";}?>">                
                            <label class="control-label" for="formulario_personas_persona_contactar_area_cargo_<?= $i ?>">Área o cargo</label>
                            <input type="text" id="formulario_personas_persona_contactar_area_cargo_<?= $i ?>" name="formulario_personas[PERSONA_CONTACTAR][<?= $i ?>][AREA_CARGO]" 
                                   mayusculasespacios="^[A-Za-zÁÉÍÓÚáéíóúÑñ\s]+$" 
                                   maxlength="150" 
                                   class="form-control" 
                                   
                                    <?php if(form_error('formulario_personas[PERSONA_CONTACTAR]['.$i.'][AREA_CARGO]') != '' ){?>
                                    aria-describedby="formulario_personas_persona_contactar_area_cargo_<?= $i ?>-error"
                                   <?php } ?>
                                   ...
                                   <?php if(form_error('formulario_personas[PERSONA_CONTACTAR]['.$i.'][AREA_CARGO]') != '' ){?>
                                    <span id="formulario_personas_persona_contactar_area_cargo_<?= $i ?>-error" class="help-block">
                                            <?= form_error('formulario_personas[PERSONA_CONTACTAR]['.$i.'][AREA_CARGO]') ?>
                                    </span>
                                    <?php } ?>
                        </div>
                    </div>
                ...
                <div class="row persona-a-contactar-<?= $i ?>">
                     <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="form-group form-group-sm <?php if(form_error('formulario_personas[PERSONA_CONTACTAR]['.$i.'][CELULAR]') != '' ){ echo "has-error";}?>">                
                            <label class="control-label" for="formulario_personas_persona_contactar_celular_<?= $i ?>">Celular</label>
                            <div class="input-group">
                                <span class="input-group-addon left"><span class="glyphicon glyphicon-phone"></span></span>
                                <input type="text" id="formulario_personas_persona_contactar_celular_<?= $i ?>" name="formulario_personas[PERSONA_CONTACTAR][<?= $i ?>][CELULAR]" 
                                      
                                    <?php if(form_error('formulario_personas[PERSONA_CONTACTAR]['.$i.'][CELULAR]') != '' ){?>
                                    aria-describedby="formulario_personas_persona_contactar_celular_<?= $i ?>-error"
                                   <?php } ?>
                                     ...
                                     id-campo="#formulario_personas_persona_contactar_telefono_<?= $i ?>"
                                     indice="<?= $i ?>"
                                     class="form-control" />
                                
                                     <?php if(form_error('formulario_personas[PERSONA_CONTACTAR]['.$i.'][CELULAR]') != '' ){?>
                                    <span id="formulario_personas_persona_contactar_celular_<?= $i ?>-error" class="help-block">
                                            <?= form_error('formulario_personas[PERSONA_CONTACTAR]['.$i.'][CELULAR]') ?>
                                    </span>
                                    <?php } ?>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="form-group form-group-sm <?php if(form_error('formulario_personas[PERSONA_CONTACTAR]['.$i.'][TELEFONO]') != '' ){ echo "has-error";}?>">                           
                                <label class="control-label" for="formulario_personas_persona_contactar_telefono_<?= $i ?>">Teléfono</label>
                                 <div class="input-group">
                                    <span class="input-group-addon left"><span class="glyphicon glyphicon-phone-alt"></span></span>
                                    <input type="text" id="formulario_personas_persona_contactar_telefono_<?= $i ?>" name="formulario_personas[PERSONA_CONTACTAR][<?= $i ?>][TELEFONO]" 
                                          
                                         <?php if(form_error('formulario_personas[PERSONA_CONTACTAR]['.$i.'][TELEFONO]') != '' ){?>
                                    aria-describedby="formulario_personas_persona_contactar_telefono_<?= $i ?>-error"
                                   <?php } ?>
                                        ...
                                        id-campo="#formulario_personas_persona_contactar_celular_<?= $i ?>"
                                        indice="<?= $i ?>"
                                        class="form-control" />
                                    
                                         <?php if(form_error('formulario_personas[PERSONA_CONTACTAR]['.$i.'][TELEFONO]') != '' ){?>
                                    <span id="formulario_personas_persona_contactar_telefono_<?= $i ?>-error" class="help-block">
                                            <?= form_error('formulario_personas[PERSONA_CONTACTAR]['.$i.'][TELEFONO]') ?>
                                    </span>
                                    <?php } ?>
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="form-group form-group-sm <?php if(form_error('formulario_personas[PERSONA_CONTACTAR]['.$i.'][CORREO_ELECTRONICO]') != '' ){ echo "has-error";}?>">                
                            <label class="control-label" for="formulario_personas_persona_contactar_correo_electronico_<?= $i ?>">Correo electrónico</label>
                            <div class="input-group">
                                <span class="input-group-addon left"><span class="glyphicon glyphicon-envelope"></span></span>
                                <input type="email" id="formulario_personas_persona_contactar_correo_electronico_<?= $i ?>" 
                                       
                                       <?php if(form_error('formulario_personas[PERSONA_CONTACTAR]['.$i.'][CORREO_ELECTRONICO]') != '' ){?>
                                    aria-describedby="formulario_personas_persona_contactar_correo_electronico_<?= $i ?>-error"
                                   <?php } ?>
                                       
                                       name="formulario_personas[PERSONA_CONTACTAR][<?= $i ?>][CORREO_ELECTRONICO]" 
                                        ...
                                        value="<?= $PERSONA_CONTACTAR[$i]['CORREO_ELECTRONICO'] ?>"
                                         <?php } ?>
                                       maxlength="80" email="email" 
                                       posicion="<?= $i ?>" 
                                       class="form-control" />
                                
                                
                                   <?php if(form_error('formulario_personas[PERSONA_CONTACTAR]['.$i.'][CORREO_ELECTRONICO]') != '' ){?>
                                    <span id="formulario_personas_persona_contactar_correo_electronico_<?= $i ?>-error" class="help-block">
                                            <?= form_error('formulario_personas[PERSONA_CONTACTAR]['.$i.'][CORREO_ELECTRONICO]') ?>
                                    </span>
                                    <?php } ?>
...
<script type="text/javascript">
   ...
   $('#rootwizard').bootstrapWizard({
        ...
        else
        {
            ...
            {
                var url = '<?php echo base_url(); ?>index.php/clientes/clientes/buscarClienteJuridicoXNroDucumento'; // El script a dónde se realizará la petición.
                ...
                if(nroDocumento !=='')
                {
                    ...
                    $.ajax({
                        ...
                        success: function (data)
                        {
                            ...
                            if (data != null)
                            {
                               var urlCreacionBasicaPN = "<?php echo base_url(); ?>index.php/clientes/clientes/mostrarFormularioGestionPJ/"+data.ID_CLIENTE;
