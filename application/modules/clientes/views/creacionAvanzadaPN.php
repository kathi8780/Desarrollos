...
<form name="formulario_personas" method="post" action="<?php echo base_url(); ?>index.php/clientes/clientes/procesarFormularioGestionPN<?php if(isset($ID_CLIENTE) && $ID_CLIENTE != NULL){ echo "/".$ID_CLIENTE ;} ?>" enctype="multipart/form-data">
    ...
    <div id="rootwizard">
                    ...
                    <ul class="nav-justified">
                        ...
                        <li>
                            <a href="#tab2" data-toggle="tab" class="step">
                                ...
                                <span class="desc" style="text-align: right;">
                                    <span style="display: none" class="glyphicon glyphicon-ok" aria-hidden="true"></span>
        ...
        <div class="tab-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="form-group form-group-sm <?php if(form_error('formulario_personas[ID_PROVINCIA_NACIMIENTO]') != '' ){ echo "has-error";}?>">
                            <div>                 
                                <label class="control-label " for="formulario_personas_idProvinciaNacimiento">Provincia de nacimiento<span class="required">  </span></label>
                        ...
                        <div class="form-group form-group-sm">                
                            ...
                            <select disabled="true" class="form-control">
                                ...
                                <?php foreach ($ocupaciones as $ocupacion) { ?>
                                    <option value="<?php echo $ocupacion['OCUPACION']; ?>" <?php if ($ocupacion['OCUPACION'] == "ESTUDIANTE") { ?> selected="selected" <?php } ?>>
                                        <?php echo $ocupacion['OCUPACION']; ?>
                                    </option>
                                <?php } ?>
                            </select>
                            <input type="hidden" id="formulario_personas_idOcupacion" name="formulario_personas[OCUPACION]" value="1"/>
                        </div>
                    </div>
            ...
            <div class="tab-pane" id="tab2">
             <h5 class="form-section">Información Académica</h5>
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="form-group form-group-sm <?php if(form_error('formulario_personas[EST_COLEGIO_GRADUACION]') != '' ){ echo "has-error";}?>">                
                            <label class="control-label required" for="formulario_personas_colegioGraduacion">Colegio Graduación<span class="required"> * </span></label>                            
                            <input type="text" id="formulario_personas_colegioGraduacion" name="formulario_personas[EST_COLEGIO_GRADUACION]" 
                                    <?php if(form_error('formulario_personas[EST_COLEGIO_GRADUACION]') != '' ){?>
                                    aria-describedby="formulario_personas_colegioGraduacion-error"
                                   <?php } ?>
                                   required="required" maxlength="50" class="form-control" 
                                   <?php if(isset($EST_COLEGIO_GRADUACION) && $EST_COLEGIO_GRADUACION != NULL) { ?> value="<?= $EST_COLEGIO_GRADUACION ?>" <?php } ?>
                                   />
                                    <?php if(form_error('formulario_personas[EST_COLEGIO_GRADUACION]') != '' ){?>
                                        <span id="formulario_personas_colegioGraduacion-error" class="help-block">
                                            <?= form_error('formulario_personas[EST_COLEGIO_GRADUACION]') ?>
                                        </span>
                                    <?php } ?>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="form-group form-group-sm <?php if(form_error('formulario_personas[EST_ANO_GRADUACION]') != '' ){ echo "has-error";}?>">                
                            <label class="control-label required" for="formulario_personas_anoGraduacion">Año Graduación<span class="required"> * </span></label>                            
                            <input digits="digits" type="text" id="formulario_personas_anoGraduacion" name="formulario_personas[EST_ANO_GRADUACION]" 
                                    <?php if(form_error('formulario_personas[EST_ANO_GRADUACION]') != '' ){?>
                                    aria-describedby="formulario_personas_anoGraduacion-error"
                                   <?php } ?>
                                   required="required" maxlength="50" class="form-control" 
                                   <?php if(isset($EST_ANO_GRADUACION) && $EST_ANO_GRADUACION != NULL) { ?> value="<?= $EST_ANO_GRADUACION ?>" <?php } ?>
                                   />
                                    <?php if(form_error('formulario_personas[EST_ANO_GRADUACION]') != '' ){?>
                                        <span id="formulario_personas_anoGraduacion-error" class="help-block">
                                            <?= form_error('formulario_personas[EST_ANO_GRADUACION]') ?>
                                        </span>
                                    <?php } ?>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="form-group form-group-sm <?php if(form_error('formulario_personas[EST_PAIS_GRADUACION]') != '' ){ echo "has-error";}?>">                
                            <label class="control-label required" for="formulario_personas_paisGraduacion">País de Graduación<span class="required"> * </span></label>
                            <select id="formulario_personas_paisGraduacion" 
                                    <?php if(form_error('formulario_personas[EST_PAIS_GRADUACION]') != '' ){?>
                                    aria-describedby="formulario_personas_paisGraduacion-error"
                                   <?php } ?>
                                    name="formulario_personas[EST_PAIS_GRADUACION]" required="required" class="form-control">
                                <option value="">SELECCIONE UN PAÍS</option> 
                                <?php foreach ($paises as $pais) { ?>
                                <option value="<?php echo $pais['ID_PAIS']; ?>" <?php if (isset($EST_PAIS_GRADUACION) && $pais['ID_PAIS'] == $EST_PAIS_GRADUACION) { ?> selected="selected" <?php } ?>>
                                        <?php echo $pais['PAIS']; ?>
                                    </option>
                                <?php } ?>
                            </select>
                            <?php if(form_error('formulario_personas[EST_PAIS_GRADUACION]') != '' ){?>
                                        <span id="formulario_personas_paisGraduacion-error" class="help-block">
                                            <?= form_error('formulario_personas[EST_PAIS_GRADUACION]') ?>
                                        </span>
                                    <?php } ?>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="form-group form-group-sm <?php if(form_error('formulario_personas[EST_TITULO_BACHILLER]') != '' ){ echo "has-error";}?>">                
                            <label class="control-label required" for="formulario_personas_tituloBachiller">Título Bachiller<span class="required"> * </span></label>                            
                            <input  type="text" id="formulario_personas_tituloBachiller" name="formulario_personas[EST_TITULO_BACHILLER]" 
                                    <?php if(form_error('formulario_personas[EST_TITULO_BACHILLER]') != '' ){?>
                                    aria-describedby="formulario_personas_tituloBachiller-error"
                                   <?php } ?>
                                   required="required" maxlength="50" class="form-control" 
                                   <?php if(isset($EST_TITULO_BACHILLER) && $EST_TITULO_BACHILLER != NULL) { ?> value="<?= $EST_TITULO_BACHILLER ?>" <?php } ?>
                                   />
                                    <?php if(form_error('formulario_personas[EST_TITULO_BACHILLER]') != '' ){?>
                                        <span id="formulario_personas_tituloBachiller-error" class="help-block">
                                            <?= form_error('formulario_personas[EST_TITULO_BACHILLER]') ?>
                                        </span>
                                    <?php } ?>
                        </div>
                    </div>
                ...
                <h5 class="form-section">Credenciales</h5>

                <div class="row">                   
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group form-group-sm <?php if(form_error('formulario_personas[USUARIO]') != '' ){ echo "has-error";}?>">                
                            <label class="control-label required" for="formulario_personas_usuario">Usuario<span class="required">  </span></label>                            
                            <input disabled="true" type="text" id="formulario_personas_usuario" name="formulario_personas[USUARIO]" 
                                    <?php if(form_error('formulario_personas[USUARIO]') != '' ){?>
                                    aria-describedby="formulario_personas_usuario-error"
                                   <?php } ?>
                                   required="required" maxlength="50" class="form-control" 
                                   ...
                                   />
                                    <?php if(form_error('formulario_personas[USUARIO]') != '' ){?>
                                        <span id="formulario_personas_usuario-error" class="help-block">
                                            <?= form_error('formulario_personas[USUARIO]') ?>
                                        </span>
                                    <?php } ?>
                        </div>
                    </div>
                     <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group form-group-sm <?php if(form_error('formulario_personas[CONTRASENA]') != '' ){ echo "has-error";}?>">                
                            <label class="control-label required" for="formulario_personas_contrasena">Contraseña<span class="required"> * </span></label>                            
                            <input style="text-transform: none;" type="pass"  autocomplete="off" id="formulario_personas_contrasena" name="formulario_personas[CONTRASENA]" 
                                    <?php if(form_error('formulario_personas[CONTRASENA]') != '' ){?>
                                    aria-describedby="formulario_personas_contrasena-error"
                                   <?php } ?>
                                   required="required" maxlength="30" minlength="8" class="form-control" 
                                   <?php if(isset($CONTRASENA) && $CONTRASENA != NULL) { ?> value="<?= $CONTRASENA ?>" <?php } ?>
                                   />
                                    <?php if(form_error('formulario_personas[CONTRASENA]') != '' ){?>
                                        <span id="formulario_personas_contrasena-error" class="help-block">
                                            <?= form_error('formulario_personas[CONTRASENA]') ?>
                                        </span>
                                    <?php } ?>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group form-group-sm <?php if(form_error('formulario_personas[ESTADO]') != '' ){ echo "has-error";}?>">                
                            <label class="control-label required" for="formulario_personas_estado">Estado<span class="required">  </span></label>                            
                            <input  disabled="true" type="text" id="formulario_personas_estado" name="formulario_personas[ESTADO]" 
                                    <?php if(form_error('formulario_personas[ESTADO]') != '' ){?>
                                    aria-describedby="formulario_personas_estado-error"
                                   <?php } ?>
                                   required="required" maxlength="50" class="form-control" 
                                   <?php if(isset($ESTADO)) { ?> 
                                   value="<?php if($ESTADO==1){echo "ACTIVO";} else {echo "INACTIVO";} ?>" 
                                   <?php } else { ?>
                                   value="<?php echo "INACTIVO"; ?>" 
                                   <?php } ?>
                                   />
                                    <?php if(form_error('formulario_personas[ESTADO]') != '' ){?>
                                        <span id="formulario_personas_estado-error" class="help-block">
                                            <?= form_error('formulario_personas[ESTADO]') ?>
                                        </span>
                                    <?php } ?>
                        </div>
                    </div>
