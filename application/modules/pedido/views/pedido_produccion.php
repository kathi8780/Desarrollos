    ...
    <div class="container">
    	<div id="tabla" class="table-responsive" style="font-size:11px; cursor: pointer">
         <table class="table table-condensed table-striped table-responsive" id="tablaGenerada">
            ...
            <?php                 
                for($i=0;$i<count($pedido_produccion);$i++)
                {
            ?>
                <tr  
                    class="
                ...
                >
                     ...
                     <td style="cursor:pointer" onclick="detallePedido('<?php echo $pedido_produccion[$i]['numero'] ?>')">
                          <?php echo $pedido_produccion[$i]['numero'] ?>
                     </td>
                     <td style="cursor:pointer" onclick="detallePedido('<?php echo $pedido_produccion[$i]['numero'] ?>')">
                          <?php echo $pedido_produccion[$i]['cliente'] ?>
                     </td>
                     <td style="cursor:pointer" onclick="detallePedido('<?php echo $pedido_produccion[$i]['numero'] ?>')">
                          <?php echo $pedido_produccion[$i]['paciente'] ?>
                     </td>
                     <td style="cursor:pointer" onclick="detallePedido('<?php echo $pedido_produccion[$i]['numero'] ?>')">
                          <?php echo $pedido_produccion[$i]['medico'] ?>
                     </td>
                     <td style="cursor:pointer" onclick="detallePedido('<?php echo $pedido_produccion[$i]['numero'] ?>')">
                         <?php echo $pedido_produccion[$i]['fing'] ?>
                     </td>
                     <td style="cursor:pointer" onclick="detallePedido('<?php echo $pedido_produccion[$i]['numero'] ?>')">
                         <?php echo $pedido_produccion[$i]['NOMBRE_PRUEBA'] ?>
                     </td>
                     <td style="cursor:pointer" onclick="detallePedido('<?php echo $pedido_produccion[$i]['numero'] ?>')">
                         <?php echo $pedido_produccion[$i]['FECHA_PRUEBA'] ?>
                     </td>
                     <td style="cursor:pointer" onclick="detallePedido('<?php echo $pedido_produccion[$i]['numero'] ?>')">
                         <?php echo $days.' days';    ?>
                     </td>
