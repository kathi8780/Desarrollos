            ...
            <div class="row" >
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                    ...
                    <div class='input-group'>
                        ...
                        <input type="text" id="fecha_inicio" placeholder="yyyy-mm-dd" class="form-control dp" style="height:30px" readonly  value="<?php $fecha = date("Y-m-d"); echo $fecha; ?>" />   
                    </div>
                </div>   
                <div class="col-md-3 col-sm-3 col-xs-12">
...
<script type="text/javascript">
            ...
            $.isLoading({
                          ...
                          position: "overlay"
				            ...
				            $.ajax({
				                     ...
				                     dataType: 'json',
				                     data: {},
				                     url: '<?php echo base_url(); ?>index.php/pedido/pedidos/getPedidosEnProduccion',
        ...
        function generarTablaDinamica(pedidos)
        {
            ...
            var filaCabecera = document.createElement("tr");
			            ...
			            var textoCelda1 = document.createTextNode("Nº");
			            ...
			            var textoCelda6 = document.createTextNode("PRUEBA");
			            var textoCelda7 = document.createTextNode("FECHA PRUEBA");
			            var textoCelda8 = document.createTextNode("DIAS");
			            ...
			            for (var i = 0; i < pedidos.length; i++)
			            {
			                ...
			                var paciente = pedidos[i]['NOMBRE_APELLIDO']; if(paciente==null)paciente="";
			                var medico = pedidos[i]['MEDICO_TRATANTE']; if(medico==null)medico="";
			                var f_ing = pedidos[i]['FECHA_COTIZACION']; 
			                var prueba = pedidos[i]['NOMBRE_PRUEBA']; 
			                var fecha_prueba = pedidos[i]['FECHA_SALIDA'];
			                var dias = pedidos[i]['DIAS'];

			                var fila = document.createElement("tr");
			                if(parseInt(dias)>0)
			                	fila.setAttribute("class","alert alert-success");
			                else
			                	fila.setAttribute("class","alert alert-danger");
			                ...
			                var textoCelda6 = document.createTextNode(prueba);
			                var textoCelda7 = document.createTextNode(fecha_prueba);
			                var textoCelda8 = document.createTextNode(dias);
            ...
            tabla.setAttribute("class","table table-condensed table-responsive");
                ...
                'aButtons': [
                    {
                        ...
                        'sFileName': 'Reporte de Inscripcion.xls'
                    }/*,
                    {
                        'sExtends': 'print',
                        'bShowAll': true,
                    ...
                    },
                    {
                        ...
                        'sFileName': 'Reporte de Inscripcion.pdf'
                    }*/
                ],
