...
<div style="min-height:500px">
    <div class="panel panel-primary" style="border:none">
        <div class="panel-heading">Consultar Pedidos por Facturar</div>
        <div class="panel-body">
            <div class="row" >
    ...
    <script type="text/javascript">
            ...
            $.isLoading({
                          ...
                          position: "overlay"
				            ...
				            $.ajax({
				                     ...
				                     dataType: 'json',
				                     data: {},
				                     url: '<?php echo base_url(); ?>index.php/pedido/pedidos/obtenerPedidosFacturados',
        ...
        function generarTablaDinamica(pedidos)
        {
            ...
            var filaCabecera = document.createElement("tr");
			            ...
			            var textoCelda6 = document.createTextNode("TOTAL PEDIDO");
			            var textoCelda7 = document.createTextNode("FLETE");
			            var textoCelda8 = document.createTextNode("RECARGO 20%");
			            var textoCelda9 = document.createTextNode("ABONO");
			            var textoCelda10 = document.createTextNode("SALDO");
			            var textoCelda11 = document.createTextNode("ESTADO");
			            var textoCelda12 = document.createTextNode("FACTURADO");
			            ...
			            for (var i = 0; i < pedidos.length; i++)
			            {
			                ...
			                var textoCelda6 = document.createTextNode(total_p);
			                var textoCelda7 = document.createTextNode(flete);
			                var textoCelda8 = document.createTextNode(recargo);
			                var textoCelda9 = document.createTextNode(abono);
			                var textoCelda10 = document.createTextNode(saldo);
			                var textoCelda11 = document.createTextNode(estado);
			                var textoCelda12 = document.createTextNode(facturado);
			                ...
			                btn.setAttribute("value", accion );
			                btn.setAttribute("onclick","accionar("+id_persona+")");
			                celdaBtn.appendChild(btn);
			                celdaBtn.setAttribute("style","text-align:right");*/
                ...
                'aButtons': [
                    {
                        ...
                        'sFileName': 'Reporte de Pedidos por Facturar.xls'
                    }/*,
                    {
                        'sExtends': 'print',
                        'bShowAll': true,
                    ...
                    }*/,
                    {
                        ...
                        'sFileName': 'Reporte de Pedidos por Facturar.pdf'
                    }
                ],
