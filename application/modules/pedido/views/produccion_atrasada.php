         ...
         <table class="table table-condensed table-striped table-responsive" id="tablaGenerada">
            ...
            ?>
                <tr onclick="detallePedido('<?php echo $pedidos_atrasados[$i]['numero'] ?>')" >
                     ...
                     <td>
                          <?php echo $pedidos_atrasados[$i]['numero'] ?>
                     </td>
                     <td>
                          <?php echo $pedidos_atrasados[$i]['cliente'] ?>
                     </td>
                     <td>
                          <?php echo $pedidos_atrasados[$i]['paciente'] ?>
                     </td>
                     <td>
                          <?php echo $pedidos_atrasados[$i]['medico'] ?>
                     </td>
                     <td>
                         <?php echo $pedidos_atrasados[$i]['fing'] ?>
                     </td>
                     <td>
                         <?php echo $pedidos_atrasados[$i]['total'] ?>
                     </td>
                     <td>
                         <?php echo $pedidos_atrasados[$i]['flete'] ?>
                     </td>
                     <td>
                     <?php echo $pedidos_atrasados[$i]['recargo'] ?>
                     </td>
                     <td>
                        <?php echo $pedidos_atrasados[$i]['abono'] ?>
                     </td>
                     <td >
                       <?php echo $pedidos_atrasados[$i]['saldo'] ?>
                     </td>
                     <td >
                       <?php 
                            if($pedidos_atrasados[$i]['estado']=="PENDIENTE" )
                                $pedidos_atrasados[$i]['estado']="PRODUCCIÓN";
                       echo $pedidos_atrasados[$i]['estado'] 
                       ?>
                     </td>
                     <td style="text-align:center">
                        <?php echo $pedidos_atrasados[$i]['facturado'] ?>
                     </td>
                     <td >
                       <?php echo $pedidos_atrasados[$i]['motivo'] ?>
                     </td>
                </tr>
            <?php                 
               }
                ...
                'aButtons': [
                    {
                        ...
                        'sFileName': 'Reporte de Producción Atrasada.xls'
                    }/*,
                    {
                        'sExtends': 'print',
                        'bShowAll': true,
                    ...
                    }*/,
                    {
                        ...
                        'sFileName': 'Reporte de Producción Atrasada.pdf'
                    }
                ],
